                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <form method="POST" action="{{ route('register-step2.create') }}" enctype="multipart/form-data">
                                ...
                                <div class="mt-4">
                                    <x-label for="about" value="{{ __('Short intro about yourself') }}" />
                                    <x-input id="about" class="block mt-1 w-full" type="text" name="about" :value="old('about')" required autofocus autocomplete="about" />
                                </div>

                                <div class="mt-4">
                                    <x-label for="motivation" value="{{ __('Why do you like to joinTimebank.cc?') }}" />
                                    <x-input id="motivation" class="block mt-1 w-full" type="text" name="motivation" :value="old('motivation')" required autofocus autocomplete="motivation" />
                                </div>
