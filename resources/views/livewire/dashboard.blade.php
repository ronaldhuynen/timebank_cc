...
@else
    ...
    <div class="mt-8 text-2xl">
        Welcome {{ $user['firstName'] }}, this is your dashboard !
    </div>
                ...
                <div class="grid grid-cols-1 bg-gray-200 bg-opacity-25 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            <svg class="h-8 w-8 text-gray-400" fill="none" stroke-linecap="round"
                    ...
                    <div class="border-t border-gray-200 p-6 md:border-l md:border-t-0">
                        <div class="flex items-center">
                            <svg class="h-8 w-8 text-gray-400" fill="none" stroke-linecap="round"
                                 stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
                                <path
