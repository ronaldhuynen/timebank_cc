<x-jetstream.form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-3 mb-3" x-show="! photoPreview">
                    <img src="{{ Storage::url(Session('activeProfilePhoto')) }}" alt="{{ getActiveProfile()->name }}" class="rounded-full h-20 w-20 object-cover">
                </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jetstream.input id="name" type="text" class="mt-1 block w-full text-gray-500
        bg-gray-100 bg-clip-padding
        border border-solid border-gray-300" wire:model="state.name" autocomplete="name" disabled/>
