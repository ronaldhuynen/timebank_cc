...
<x-dynamic-component :component="$layout">
    <div class=" mt-48 mb-36 flex flex-col items-center justify-center">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-200">404</h1>
        <p class="text-lg text-gray-600 dark:text-gray-400 mt-4">{{ __($exception->getMessage() ?: 'Forbidden') }}</p>
