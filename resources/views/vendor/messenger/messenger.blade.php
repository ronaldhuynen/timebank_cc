                ...
                <div class="bg-light px-3 mt-3 mb-1 d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" onclick="ThreadManager.load().search(); return false;" href="#"><i class="fas fa-user-plus"></i> &nbsp; {{__('Search Users')}}</a>
                            <a class="dropdown-item" onclick="ThreadManager.load().contacts(); return false;" href="#"><i class="fas fa-user-check"></i> &nbsp; {{__('Friends')}}</a>
                            <a class="dropdown-item" onclick="ThreadManager.load().createGroup(); return false;" href="#"><i class="fas fa-user-friends"></i> &nbsp; {{__('New Group')}}</a>
                            {{-- <a class="dropdown-item" onclick="MessengerSettings.show(); return false;" href="#"><i class="fas fa-wrench"></i> &nbsp; {{__('Settings')}}</a> --}}
                        </div>
                    </div>
                </div>

                <div id="threads_search_bar" class="NS card-header bg-light">
                    ...
                    <div class="form-row">
                        <div class="input-group input-group-sm col-12 mb-0">
                            ...
                            <input autocomplete="off" type="search" class="form-control shadow-sm" id="thread_search_input" placeholder="{{__('Search conversations by name')}}" />
                        </div>
                    </div>
                </div>
