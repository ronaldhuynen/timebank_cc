        ...
        <div class="grid grid-cols-6 gap-6">
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-4">
                    ...
                    <x-jetstream.input :value="old('name')" autocomplete="name" autofocus
                                        class="mt-1 block w-full" name="name" name="name" required
                                        type="text" type="text" wire:model.blur="name" />
                </div>
                @error('name')
                ...
                <div class="mt-4">
                    ...
                    <x-jetstream.input autocomplete="new-password" class="mt-1 block w-full"
