<div x-data class="mt-4 max-w-md">
    ...
    <div class="relative">
        ...
        @if (!isset($selectedId) || $search != '')
            ...
            @if (strlen($search) > 2)
                <ul
                    class="absolute z-[60] mt-0 w-full rounded-md border border-gray-300 bg-white text-sm text-gray-700 shadow-lg">
            ...
            @endif
        <div
                class=" focus:shadow-outline-blue mt-2 w-full rounded-md border border-gray-300 bg-white pl-0 pr-3 leading-5 transition duration-150 ease-in-out focus:border-indigo-300 focus:outline-none sm:text-sm">
