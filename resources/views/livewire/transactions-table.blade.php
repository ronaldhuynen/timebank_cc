<div class="my-4">
    ...
    <div class="relative mb-20 mt-12 w-full min-w-full leading-normal">
        <div class="absolute right-0 top-0 my-1">
            <x-button label="{{ __('PDF') }}" outline right-icon="arrow-down-tray" secondary xs 
                spinner="exportTransactions('pdf')" 
                wire:click="exportTransactions('pdf')" />
            <x-button label="{{ __('ODS') }}" outline right-icon="arrow-down-tray" secondary xs 
                spinner="exportTransactions('ods')" 
                wire:click="exportTransactions('ods')" />
            <x-button label="{{ __('XLSX') }}" outline right-icon="arrow-down-tray" secondary xs 
                spinner="exportTransactions('xlsx')" 
                wire:click="exportTransactions('xlsx')" />
            <x-button label="{{ __('CSV') }}" outline right-icon="arrow-down-tray" secondary xs 
                spinner="exportTransactions('csv')" 
                wire:click="exportTransactions('csv')" />
            <x-button label="{{ __('MT940') }}" outline right-icon="arrow-down-tray" secondary xs 
                spinner="exportTransactions('mt940')" 
